...
const ClientDetailProductPage = ({ id } : { id : string }) => {
  ...
  return (
    <div className='backdrop-blur-md relative flex mb-20 min-h-96 shadow-white/20 shadow-md flex-col items-center mt-4 mx-auto lg:gap-20 w-[90%] md:mt-8 lg:w-4/5'>
        <button title='Back to previous page' className='mr-auto mb-4 text-gray-700 absolute lg:-left-12' onClick={() => router.back()}>
