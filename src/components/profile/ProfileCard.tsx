...
const ProfileCard = () => {
  ...
  return (
    <div className="mt-10 mb-24 min-h-56 border mx-5 transition-all duration-300 lg:items-start md:mt-16 rounded-xl border-gray-700 hover:shadow-md relative hover:shadow-gray-700 lg:px-10">
        ...
        <button onClick={() => signOut({ callbackUrl : "/" })} className="right-10 absolute bottom-4 h-10 bg-black text-white hover:bg-black/70 md:bottom-12 active:bg-black/50  px-4 py-1 rounded font-bold ">SIGN OUT</button>
    </div>
  )
}
