...
const ProfileCard = () => {
  ...
  return (
    <div className=" my-10 min-h-40 border mx-5 transition-all duration-300 rounded-xl border-gray-700 hover:shadow-md  hover:shadow-gray-700 lg:px-10">
        ...
        <div className="flex mb-5 mt-2 items-start justify-between  lg:px-6 lg:text-xl lg:mb-8 lg:mt-8">
          <section className='lg:flex lg:items-center lg:gap-10'>
            <div className="size-14 rounded-full bg-black ml-4"></div>
        ...
        <button onClick={handleLogOut} className="right-10  bottom-2 bg-black text-white hover:bg-black/70 active:bg-black/50  px-4 py-1 rounded font-bold ">
            LOG OUT
        </button>
        </div>
    </div>
