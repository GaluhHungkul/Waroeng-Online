...
const LoginPage = () => {
  ...
  return (
    <div style={{ backgroundImage : "url(/assets/img/bg.jpg)" }} className='pt-5 bg-cover bg-center min-h-screen relative'>
      <div className='absolute inset-0 backdrop-blur-md'/>
      <div className="flex min-h-[85vh] bg-gray-200/70 w-4/5 justify-center flex-col px-6 pb-8 lg:px-8 backdrop-blur-sm border border-gray-300 lg:w-1/3  shadow-xl mx-auto rounded-xl">
        <h2 className="text-center text-xl lg:text-2xl font-bold text-black lg:mt-5">Sign in to your account</h2>             
        <div className="mt-10 w-80 lg:w-full relative lg:left-11">
          ...
          <GoogleLoginButton />
          <p className="mt-10 w-4/5 text-center text-sm/6 text-gray-500">
